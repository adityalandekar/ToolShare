...
class ActiveTransactions(models.Model):
    ...
    notification_info = models.CharField(max_length=20)
...
class ToolHistory(models.Model):
    ...
    borrower_id = models.ForeignKey(UserProfile, related_name='borrower_id_history')
    owner_id = models.ForeignKey(UserProfile, related_name='owner_id_history')
